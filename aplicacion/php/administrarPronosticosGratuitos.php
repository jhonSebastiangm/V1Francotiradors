...
<body>
  ...
  <div class="container">
      <div class="row p-4">
        ...
        <a class="navbar-brand" href="#">Agregar Pronosticos Gratuitos</a>
          <div class="card">
            <div class="card-body">
              
              <!-- FORM TO ADD TASKS -->
              <form id="PronosticoGratuito">
        ...
        <a class="navbar-brand" href="#">Crear Item</a>
          <div class="card">
            <div class="card-body">
              ...
              <!-- FORM TO ADD TASKS -->
              <form id="ItemsPronosticoGratuito">
        ...
        <a class="navbar-brand" href="#">Crear Resultado</a>
          <div class="card">
            <div class="card-body">
              ...
              <!-- FORM TO ADD TASKS -->
              <form id="PronosticoGratuitoCrearResultado">
        ...
        <!-- TABLE  -->
        <div class="col-md-6">
        <a class="navbar-brand" href="#">Pronosticos Gratuitos</a>
          <table class="table table-bordered table-sm">
            <thead>
              <tr>
                <td>Equipo 1</td>
    ...
    <div class="container">
      <div class="row p-4">
        <div class="col-md-6">
        <a class="navbar-brand" href="#">Agregar Fecha Nuevo Pronosticos Gratuitos</a>
          <div class="card">
            <div class="card-body">
  ...
  <script src="../js/administrarPronosticosGratuitos.js"></script>
  <script src="../js/fechaGratuita.js"></script>
