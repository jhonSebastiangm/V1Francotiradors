$(document).ready(function() {
    ...
    $('#PronosticoBasico').submit(e => {
      ...
      const url ='../php/AgregarPronosticoBasico.php';
    ...
    $('#ItemsPronosticoBasico').submit(e => {
      ...
      const url ='../php/AgregarItemsPronosticoBasico.php';
    ...
    $('#PronosticoBasicoCrearResultado').submit(e => {
      ...
      const url ='../php/ModificarEstadoPronosticoBasico.php';
    ...
    function buscarPronosticosBasicos() {
      $.ajax({
        url: '../php/buscarPronosticosBasicos.php',
        type: 'GET',
    ...
    $(document).on('click', '.Resultado', function()  {
      ...
      console.log(id);
      $.post('ConsultarPronosticoBasicoId.php', {id}, (response) => {
      ...
      $.post('buscarItemsDePronosticosPorResultadoBasico.php', {id}, (response) => {
        console.log(response);
    ...
    $(document).on('click', '.Guardar',function() {
        ...
        console.log(cumple);
        $.post('GuardarItemPronosticoResultadoBasico.php', {idItemResultado,desc,resultadoInicial,cumple,valorFinal,idPronostico}, (response) => {
          alert(response);
